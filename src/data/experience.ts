    ...
    initiatives: [
      {
        ...
        description: "Led development of a fraud detection initiative for UOB's digital banking operations. Awarded Certificate of Recognition for Performance Excellence (Mar 2024).",
        tech: ["Java", "Spring Boot", "React", "SQL"],
      },
      {
        name: "AI Workflow Automation",
        description: "Integrated LLM-backed workflows using Amazon Bedrock, LangChain, and RAG pipelines into regulated environments.",
      ...
      },
      {
        ...
        description: "Built customer onboarding and identity assurance level systems integrating front-end digital banking apps with back-end systems across multiple ASEAN countries.",
    ...
    initiatives: [
      {
        ...
        description: "Led full migration of Corppass, Singapore's corporate digital identity platform, to AWS Cloud, improving scalability and authentication processing times for 200k+ businesses.",
        tech: ["AWS", "Kubernetes", "Docker", "Microservices", "React", "Java"],
        outcomes: ["200k+ businesses"],
      },
      {
        name: "Singpass QR Login",
        description: "Designed and delivered QR-based login for Singpass, enhancing security and user experience for over 5 million users with support for millions of daily authentication requests.",
        tech: ["React", "Java", "Spring", "RESTful APIs"],
        outcomes: ["5M+ users", "Millions of daily auths"],
      },
    ],
  },
  {
    ...
    initiatives: [
      {
        ...
        description: "Designed, developed, and maintained mission-critical Java applications for NEC's MS5000 R10.0 Radio platform. Awarded Presidential Award for outstanding delivery under a short development period.",
        tech: ["Java"],
      },
    ],
  },
